from models import CharacterLevelCNN, GenericModel
...
train_dataset_loader, val_dataset_loader, test_dataset_loader, num_classes = get_dataloaders(dataset_name, alphabet, max_seq_length)
config = {}
