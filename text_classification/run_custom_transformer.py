...
from models.transformers_model import CustomTransformerEncoder
...
def main(args):
    ...
    config["lr"] = args.lr
    encoder_model = CustomTransformerEncoder(
        tokenizer_config_name=args.pretrained_tokenizer_name,
        ...
        pooled_output_embedding=args.pooled_output_embedding,
    )
    ...
    wandb_logger = WandbLogger(
        ...
        tags=[
            f"custom-transformer-H{args.dim_model}-L{args.num_layers}",
            args.dataset_name,
        ],
    )
...
def parse_arguments():
    ...
    parser.add_argument("--pretrained_tokenizer_name", type=str, default="")
    parser.add_argument("--nhead", type=int, default=2)
    parser.add_argument("--dim_model", type=int, default=128)
    parser.add_argument("--dim_feedforward", type=int, default=512)
    parser.add_argument("--num_layers", type=int, default=2)
    parser.add_argument("--position_encoding_type", type=str, default="learnable")
    parser.add_argument("--pooled_output_embedding", action="store_true")
