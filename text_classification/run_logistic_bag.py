...
from data_utils.text_data import NgramTextDataModule
from models.logistic import LogisticBOWModel
...
def main(args):
    ...
    data_module = NgramTextDataModule(
        dataset_name,
    ...
    config["lr"] = args.lr
    model_embed_bag = LogisticBOWModel(
